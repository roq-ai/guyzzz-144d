...
export function ClientListPage(props: ClientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getClients({
        relations: ['user', 'notion_template.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('notion_template', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'notion_template',
          header: 'Notion Template',
          accessorKey: 'notion_template',
          cell: ({ row: { original: record } }: any) => record?._count?.notion_template,
        }
      : null,
