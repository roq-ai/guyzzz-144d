  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to guyzzz - Your Personalized Notion Template Provider. Tailoring Solutions to Perfectly Fit Your Unique Needs."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1629461461750-ef5b81781bc2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxub3Rpb258ZW58MHx8fHwxNjkwNjUwNjQ0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@studiopoline?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Pauline Bernard`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to guyzzz - Your Personalized Notion Template Provider. Tailoring Solutions to Perfectly Fit Your Unique Needs.`}
            </Text>
            <Box
